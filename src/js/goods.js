jQuery(function($){
   ...
   //to top
    ...
    var J_BigImg = document.getElementById("J_BigImg");
    ...
    xiaotu.src = paramsObj.imgurl;
    J_BigImg.src = paramsObj.imgurl;
    ...
    $(".lprice").html(paramsObj.lprice);
     ...
     // let dataname = $(".goods-title");//名字
     // let xianjia = $(".property-type-now");//现价
     // let yuanjia= $(".lprice");//原价
